    ...
    public partial class seedData : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        ...
                        InstrumentAssociated = c.Int(nullable: false),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Rate", t => t.Rating_Id)
                .Index(t => t.Rating_Id);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.InstrumentClassification", t => t.ClassificationId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Instrument", new[] { "ClassificationId" });
