...
namespace ColossalSounds.Data
{
    public class InstrumentClassification
    {
        ...
        [JsonConverter(typeof(StringEnumConverter))]
        public enum InstrumentType { trumpet = 1 , trombone = 2, tuba = 3, french_horn = 4, baritone = 5, sousaphone = 6, saxophone = 7, clarinet = 8, flute = 9, piccolo = 10, oboe = 11, basson = 12, guitar = 13, bass = 14, snare_drum = 15, drum_kit = 16, piano = 17, keyboard = 18, bells = 19, marimba = 20, xylophone = 21, cymbol = 22 }
